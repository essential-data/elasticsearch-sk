...
ENV HUNSPELL_SK_BASE https://github.com/essential-data/hunspell-sk/releases/download/1.0
# Version with ASCII folding:
ENV HUNSPELL_SK_FILE hunspell-sk_SK-ascii.tar.gz
# Version without ASCII folding:
#ENV HUNSPELL_SK_FILE hunspell-sk_SK.tar.gz
